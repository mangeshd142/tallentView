...
public class MailTest 
{
	...
	//	generateAndSendEmail();
		MailTest forgotEmail = new MailTest();
		forgotEmail.sendForgotEmail("mangeshd142@gmail.com","asdasd");
 ...
 //This class takes various attributes from webservice implementation class and send it in an email
	...
	public void sendForgotEmail(String email,String temPwd) throws AddressException, MessagingException {
        ...
        {   MimeMessage message = new MimeMessage(session);
            ...
            String[] emailids = {"support@tallentview.com",email,"mangesh142@yahoo.in"};
            
            InternetAddress[] addresses = new InternetAddress[3];
           
            int i =0;
            for (String emailid : emailids) {
            	addresses[i] = new InternetAddress(emailid.trim());
                i++;
            }
