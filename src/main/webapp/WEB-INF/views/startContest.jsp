...
alert("Submit Result.");
    ...
    var userId = ${userId};
        ...
        $.post("saveResult", { codeArea : codeArea, progid:progid, contestid:contestid,
...
<%
	userids = "";
	if (userids == null) {
		response.sendRedirect("erroronlogin.jsp");
	} else {
%>
</head>
...
$(function () {
    ...
    $(".btn").click(function () {
        ...
        window.onbeforeunload = null;
				...
				<span style="float: right; margin-right: 150px"><span
					style="font-weight: bold">Remaining Time: </span> <span id="timer"></span>
				</span>


				<%--  <%@include file="conntest/sapmleContest/addition.jsp" %>  --%>
				<jsp:include page="conntest/maincontest/${detail}"></jsp:include>
				<div>
					
				</div>
				<br /> Write Your Program:<br />
				<div>
					<form:form commandName="codeArea">
						...
						<input type="button" value="Submit Result" class="btn btn-primary"
							onclick="subRes()" />
					</form:form>
  ...
  var codearea = CodeMirror.fromTextArea(document.getElementById("codearea"), {
    ...
    mode: "text/x-java"
		    ...
		    $('form').submit(function(e) {
		        ...
		        $.post('getresult', $(this).serialize(), function(resp) {
